...
C_SRCS += \
../Src/keyboard_counter.c \
../Src/syscalls.c \
../Src/sysmem.c 

OBJS += \
./Src/keyboard_counter.o \
./Src/syscalls.o \
./Src/sysmem.o 

C_DEPS += \
./Src/keyboard_counter.d \
./Src/syscalls.d \
./Src/sysmem.d 
...
clean-Src:
	-$(RM) ./Src/keyboard_counter.cyclo ./Src/keyboard_counter.d ./Src/keyboard_counter.o ./Src/keyboard_counter.su ./Src/syscalls.cyclo ./Src/syscalls.d ./Src/syscalls.o ./Src/syscalls.su ./Src/sysmem.cyclo ./Src/sysmem.d ./Src/sysmem.o ./Src/sysmem.su
