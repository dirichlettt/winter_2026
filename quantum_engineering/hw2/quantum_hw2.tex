...
\begin{enumerate}[(a)]
  ...
  \item We have that
    \begin{align*}
      ...
      \\
      & = -\hbar \int_\bR \dd{x} e^{-ax^2} \qty(2ae^{-ax^2} - 4a^2 x^2 e^{-ax^2})
      \\
      & = -2a\hbar^2 \int_\bR \dd{x} e^{-2ax^2} + 4a^2\hbar^2 \int_\bR \dd{x} x^2 e^{-2ax^2}
      \\
      & = -2a\hbar^2 \sqrt{\frac{\pi}{2a}} + 4a^2\hbar^2 \frac{1}{4a}\sqrt{\frac{\pi}{2a}}
      \\
