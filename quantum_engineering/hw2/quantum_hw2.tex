...
\begin{enumerate}[(a)]
    ...
    \begin{align*}
        ...
        \\
        & = \frac{-4a\hbar}{i} \int_\bR \dd{x} x^2 e^{-2ax^2}
        \\
        & = \frac{-4a\hbar}{i} \qty[ x \qty(\frac{-1}{4a})e^{-2ax^2} \eval_{-\infty}^\infty + \frac{1}{4a}\int_\bR \dd{x} e^{-2ax^2} ]
        \\
        & = -\frac{\hbar}{i} \int_{\bR} \dd{x} e^{-2ax^2}
    \end{align*}
\end{enumerate}
